...
<div class="container">
    ...
    <form action="<?php echo URLROOT ?>/PackageController/edit" method="POST" enctype="multipart/form-data">
        <h1>Edit Package</h1>
        <input type="text" hidden name="pack_code" value="<?php echo $_GET["code"]?>">
        ...
        <input type="submit" value="Save changes" name="submit" style="background-color: #007bff; color: white; border: none; padding: 10px 20px; cursor: pointer;">
    </form>
