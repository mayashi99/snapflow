...
<div style="background-color: blueviolet; width: 1503px;height: 780px;">
   <div style="background-color:gray ;width: 203px;height: 780px;float :left">
...
<table>
  ...
  <td><a  style=" color: #151515;text-decoration: none;font-size: 17px;"href="<?php echo URLROOT ?>/PageController/logout">Logout</a></td>
   ...
   <div style="background-image:url('../public/images/nback2.webp');background-size:cover; background-repeat: no-repeat; width: 1300px;height: 780px; float:right; ">
