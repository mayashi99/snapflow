...
<div class="topnav">
  ...
  <div style="background-color: blueviolet; width: 1503px;height: 900px;">
        ...
        <center>
          ...
          <table>
            <tr>
              ...
              <td><a style=" color: #151515;text-decoration: none;font-size: 17px;"
                  href="<?php echo URLROOT ?>/PageController/logout">Logout</a></td>
            </tr>
          </table>
        </center>
        </form>
    ...
    <div
      style="background-image:url('../public/images/nback2.webp');background-size:cover; background-repeat: no-repeat; width: 1300px;height: 900px; float:right; ">
